...
::: tip Tip
Use the Gig Bot to help you format & share your post. You can read more by typing `/gig_bot` in your Slack message window.
:::
...
- Use "tags" to add clarity to the post, such as: `[Looking For Work][front end developer] [Junior]` or use the `/gig_bot` command.
...
- Use "tags" to add clarity to the post, such as: `[Hiring][front end developer] [React, Redux][90 - 105k]` or use the `/gig_bot` command.
