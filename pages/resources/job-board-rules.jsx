...
export default function JobBoardRules() {
  const rules = [
    `You must be an employee or directly responsible for hiring or recruiting at the company you are posting for. No third-party postings or "sharing to share.”`,
